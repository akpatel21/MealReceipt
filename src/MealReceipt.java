...
public class MealReceipt 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.print("Please enter the name of your entrée: ");
		String entréeName = keyboard.nextLine();
		System.out.print("Please enter the price for the entrée: ");
		...
		System.out.print("Please enter the price for the drink: ");
		...
		System.out.println("\nSubtotal					$" + subtotal);
		Double tax = (int)(subtotal * 0.06 * 100)/100.0;
		System.out.println("Tax					$" + tax);
		Double tip = (int)(subtotal * tipPercent * 100)/100.0;
